			...
			<td class="tr2">
				<table>
					...
					<tbody class="rtwwwap_tbody">
						...
						$rtwwwap_special_commission = isset($rtwalwm_commission_settings[ 'cat_opt_special' ])? $rtwalwm_commission_settings[ 'cat_opt_special' ]: array();
						...
						<tr class="rtwwwap_add_new_row_hide">
							...
							<!-- <select class="rtwwwap_select2" multiple="multiple"  name="rtwalwm_commission_settings_opt[cat_opt_special][]" data-placeholder="<?php echo esc_attr( 'Select categories', 'rtwalwm-wp-wc-affiliate-program' ); ?>" >
								...
								?>
									<option value="<?php echo esc_attr( $rtwwwap_category1->cat_ID ); ?>"  >
							...
							<td>
								<input class="rtwwwap_cat_percentage_commission" type="number" min="0" step="0.1" max="100" name="rtwalwm_commission_settings_opt[percent]" value=<?php echo isset( $rtwalwm_commission_settings[ 'percent' ] ) ? esc_attr( $rtwalwm_commission_settings[ 'percent' ] ) : esc_attr( '0' ); ?> />
							</td>
							<td>
								<input class="rtwwwap_cat_fixed_commission" type="number" min="0" step="0.1" name="rtwalwm_commission_settings_opt[fixed]" value=<?php echo isset( $rtwalwm_commission_settings[ 'fixed' ] ) ? esc_attr( $rtwalwm_commission_settings[ 'fixed' ] ) : esc_attr( '0' ); ?> />
							</td>
