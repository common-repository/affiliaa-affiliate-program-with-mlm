...
<div class="rtwalwm-extra-table-wrapper">
		<table class="rtwalwm-table form-table rtwalwm-show" id="rtwalwm_extra_general">
			<tbody>
				...
				<tr>
					<th><?php esc_html_e( 'Enable/disable Email verification', 'rtwalwm-wp-wc-affiliate-program' ); ?></th>
					<td class="tr2">
						<p>
							<span class="rtwalwm-custom-radio">
								<input id="radio-5" type="radio" name="" value="" disabled /><?php esc_html_e( 'On', 'rtwalwm-wp-wc-affiliate-program' ); ?>
						...
						<p>
							<span class="rtwalwm-custom-radio">
								...
								<input id="radio-6" type="radio" name="" value="" disabled/><?php esc_html_e( 'Off', 'rtwalwm-wp-wc-affiliate-program' ); ?>
